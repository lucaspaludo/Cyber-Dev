...
while True:
    ...
    somFinal.play()
    colocarTexto("GAMER OVER", fonte, janela, (LARGURA_JANELA/3), (ALTURA_JANELA/3))
    colocarTexto("pressione uma tecla para jogar novamente", fonte, janela, (ALTURA_JANELA/10), (ALTURA_JANELA/2))
    pygame.display.update()
    aguardarEntrada()
    somFinal.stop()
