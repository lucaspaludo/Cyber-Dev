...
while True:
            ...
            if evento. type == pygame.KEYDOWN:
                ...
                if evento.key == pygame.K_SPACE:
                    raio = {
                        ...
                        'objRect': pygame.Rect(jogador['objRect'].centerx - LARGURA_RAIO // 2, jogador['objRect'].top, LARGURA_RAIO, ALTURA_RAIO),
                        'vel':VEL_RAIO,
                        'imagem': imagemLaser  
                    }
                    raios.append(raio)
    ...
    somFinal.play()
    colocarTexto("GAME OVER", fonte, janela, (LARGURA_JANELA/3), (ALTURA_JANELA/3))
    colocarTexto("pressione qualquer tecla para jogar novamente", fonte, janela, (LARGURA_JANELA/10), (ALTURA_JANELA/2))
    pygame.display.update()
    aguardarEntrada()
    somFinal.stop()
