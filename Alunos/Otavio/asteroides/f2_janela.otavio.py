...
f4 = {
    'objRect':pygame.Rect(140,270,30,30),
    'cor':AZUL,
    'vel':[-5,5],
    'forma': 'RETANGULO'
}
...
deve_cantinuar = True 
while deve_cantinuar:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:

            deve_cantinuar = False
    janela.fill(PRETO)
