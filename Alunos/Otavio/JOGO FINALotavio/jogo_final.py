...
while True:
    ...
    while deve_continuar:
        ...
        for asteroide in asteroides[:]:
            ...
            if topo_asteroide > ALTURA_JANELA:asteroides.remove(asteroide)
    ...
    somFinal.play()
    colocarTexto("GAME OUVER", fonte, janela, (LARGURA_JANELA/3), (ALTURA_JANELA/3))
    colocarTexto('resione uma tecla para mover novamente', fonte, janela,(LARGURA_JANELA/10),(ALTURA_JANELA/2))
    pygame.display.update()
    aguardarEntrada()
    somFinal.stop()
