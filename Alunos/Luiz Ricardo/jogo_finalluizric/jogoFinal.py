...
while True:
    ...
    somFinal.play()
    colocarTexto("GAME OVER", fonte, janela, (LARGURA_JANELA/13), (ALTURA_JANELA/2))
    colocarTexto("Pressione uma tecla para jogar novamente", fonte, janela, (LARGURA_JANELA/2), (ALTURA_JANELA/2))
    pygame.display.update()   
    aguardaEntrada()
    somFinal.stop()
