...
f1 = {'objRect':pygame.Rect(300, 80, 40, 80), 'cor': VERDE, 'vel': [0, -5], 'forma': 'ELIPSE'}
f2 = {'objRect':pygame.Rect(200, 200, 20, 20), 'cor': AZUL, 'vel': [5, -5], 'forma': 'ELIPSE'}
f3 = {'objRect':pygame.Rect(100, 150, 60, 60), 'cor': AMARELO, 'vel': [-5, 5], 'forma': 'RETANGULO'}
f4 = {'objRect':pygame.Rect(300, 80, 40, 80), 'cor': VERMELHO, 'vel': [9, -2], 'forma': 'RETANGULO'}
f5 = {'objRect':pygame.Rect(120, 70, 30, 40), 'cor': ROXO, 'vel': [4, 3], 'forma': 'ELIPSE'}
f6 = {'objRect':pygame.Rect(150, 160, 30, 30), 'cor': BRANCO, 'vel': [7, 3], 'forma': 'RETANGULO'}

figuras = [f1, f2, f3, f4, f5, f6]
